...
class Cart(models.Model):
    ...
    def __str__(self):
        return self.product.name              # here we mentioned self.product.name beacsue product is a foreign key

    def subtotal(self):                        #it is a function to calculate total value and to show it on card.html
        return self.quantity*self.product.price   #we know that we can do properties and functions in class
